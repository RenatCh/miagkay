			...
			<main id="main" class="site-main <?php echo esc_attr($page_column_class['main_class']); ?>" >
				...
				if ( have_posts() ) :
					...
					the_posts_pagination( array(
						'prev_text' => ftc_get_svg( array( 'icon' => 'arrow-left' ) ) . '<span class="screen-reader-text">' . esc_html__( 'Previous', 'credo' ) . '</span>',
						'next_text' => '<span class="screen-reader-text">' . esc_html__( 'Next', 'credo' ) . '</span>' . ftc_get_svg( array( 'icon' => 'arrow-right' ) ),
