       ...
       <header id="masthead" class="site-header">
        ...
        <div class="header-ftc header-<?php echo esc_attr($smof_data['ftc_header_layout']); ?>">
            <div class="header-nav">
                <div class="container">
                    <div class="nav-left home6">
                        <div class="static-position">
                            <div class="marker"><i class="fa  fa-map-marker"></i> <span class="nuber-marker"> <span>Galaxy Tower - 228b Baker Street - London </span> </span></div>
                            <div class="phone"><i class="fa  fa-phone"></i> <span class="nuber-phone"> <span class="nubers">(+84). 123. 456. 789 </span>
                                    </span></div>
                        </div>
                    </div>
                    <div class="nav-right">
