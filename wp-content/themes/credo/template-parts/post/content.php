	...
	<?php if( $post_format != 'quote' ): ?>
		...
		<div class="post-info">
			...
			<div class="entry-info">
				...
				<?php if( $smof_data['ftc_blog_title'] ): ?>
					...
					<?php if ( is_sticky() && is_home() && ! is_paged() ): {
						printf( '<span class="sticky-post">%s</span>', __( 'Featured', 'credo' ) );
					}?>
			...
			<span class="tags-link">
				<span><?php esc_html_e('Tags: ','credo');?></span>
   ...
   <div class="full-content">
    ...
    ?>
		...
		<?php if( $smof_data['ftc_blog_read_more'] ): ?>
			<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'credo'); ?></a>
		<?php endif; ?>
  <?php else: ?>
