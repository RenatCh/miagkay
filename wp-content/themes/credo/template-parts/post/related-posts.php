...
if( $related_posts->have_posts() ){
	...
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="related-post-title">
			...
			<h3 class="product_title"><?php esc_html_e('Related Posts', 'credo'); ?></h3>
		...
		<div class="meta-slider">
			<div class="blogs owl-carousel">
				...
				<?php if( $smof_data['ftc_blog_count_view'] ): ?>
					...
					<?php endif; ?>
						...
						<?php if( $smof_data['ftc_blog_author'] ): ?>
							<span class="vcard author"><?php esc_html_e('Post by: ', 'credo'); ?><?php the_author_posts_link(); ?></span>
						<?php endif; ?>
						...
						<?php if ( $categories_list && $smof_data['ftc_blog_categories'] ): ?>
							<div class="caftc-link">
								<span><?php esc_html_e('Categories: ', 'credo'); ?></span>
				...
				<!-- Blog Author -->
				<!--<span class="author"><?php //esc_html_e('Post by ','credo') ?><?php //the_author_posts_link(); ?></span>-->

				<!-- Blog Read More -->
				<!--a href="<?php //the_permalink(); ?>" class="button-readmore"><?php // esc_html_e('Read More','credo') ?></a-->
			</div>
		</article>
	<?php endwhile; ?>
</div>
