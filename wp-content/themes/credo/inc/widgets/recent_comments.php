...
if( !class_exists('Ftc_Recent_Comments_Widget') ){
	class Ftc_Recent_Comments_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-recent-comments-widget', 'description' => esc_html__('Display recent comments on site', 'credo'));
			parent::__construct('ftc_recent_comments', esc_html__('FTC - Recent Comments', 'credo'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				$post_types = array_merge(array('all'=>esc_html__('All Posts', 'credo')), $post_types);
				...
				<p>
					<label for="<?php echo $this->get_field_id('post_type'); ?>"><?php echo esc_html_e('Post type', 'credo'); ?> </label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of comments to show', 'credo'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_avatar'); ?>"><?php esc_html_e('Show avatar', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_date'); ?>"><?php esc_html_e('Show comment date', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_author'); ?>"><?php esc_html_e('Show comment author', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_comment'); ?>"><?php esc_html_e('Show comment content', 'credo'); ?></label>
				</p>

				<p>
					<input type="checkbox" id="<?php echo $this->get_field_id('show_post_on'); ?>" name="<?php echo $this->get_field_name('show_post_on'); ?>" value="1" <?php echo ($instance['show_post_on'])?'checked':''; ?> />
					<label for="<?php echo $this->get_field_id('show_post_on'); ?>"><?php esc_html_e('Show post on', 'credo'); ?></label>
				</p>
