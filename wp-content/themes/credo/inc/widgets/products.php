...
if( !class_exists('Ftc_Products_Widget') ){
	class Ftc_Products_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-items-widget', 'description' => esc_html__('Display your products on site','credo'));
			parent::__construct('ftc_products', esc_html__('FTC - Products','credo'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				?>
				<p>
					<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Enter your title', 'credo'); ?> </label>
					<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
				</p>

				<p>
					<label for="<?php echo $this->get_field_id('product_type'); ?>"><?php esc_html_e('Product type', 'credo'); ?> </label>
					<select class="widefat" id="<?php echo $this->get_field_id('product_type'); ?>" name="<?php echo $this->get_field_name('product_type'); ?>">
						<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'credo'); ?></option>
						<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'credo'); ?></option>
						<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'credo'); ?></option>
						<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'credo'); ?></option>
						<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'credo'); ?></option>
						<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'credo'); ?></option>
					</select>
				</p>

				<p>
					<label><?php esc_html_e('Select categories', 'credo'); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('row'); ?>"><?php esc_html_e('Number of rows - in carousel slider', 'credo'); ?> </label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Number of posts to show', 'credo'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_thumbnail'); ?>"><?php esc_html_e('Show thumbnail', 'credo'); ?></label>
				</p>

				<p>
					<label for="<?php echo $this->get_field_id('thumbnail_size'); ?>"><?php esc_html_e('Thumbnail size', 'credo'); ?> </label>
					<select class="widefat" id="<?php echo $this->get_field_id('thumbnail_size'); ?>" name="<?php echo $this->get_field_name('thumbnail_size'); ?>">
						<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Product Thumbnails', 'credo'); ?></option>
						<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Images', 'credo'); ?></option>
						<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Product Image', 'credo'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_categories'); ?>"><?php esc_html_e('Show categories', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_product_title'); ?>"><?php esc_html_e('Show product title', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_price'); ?>"><?php esc_html_e('Show price', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_rating'); ?>"><?php esc_html_e('Show rating', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('is_slider'); ?>"><?php esc_html_e('Show in a carousel slider', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('show_nav'); ?>"><?php esc_html_e('Show navigation button', 'credo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo $this->get_field_id('auto_play'); ?>"><?php esc_html_e('Auto play', 'credo'); ?></label>
				</p>
