 ...
 */
function ftc_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Credo default saturation level.
	 *
	 * @since Credo 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'ftc_custom_colors_saturation', 50 ) );
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Credo custom colors CSS.
	 *
	 * @since Credo 1.0
	 *
	 ...
	 */
	return apply_filters( 'ftc_custom_colors_css', $css, $hue, $saturation );
}
