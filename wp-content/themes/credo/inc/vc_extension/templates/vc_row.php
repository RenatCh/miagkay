...
if( $parallax_speed != '' && $bg_type == 'image' ){
	$css_classes[] = 'ftc-prlx-background';
...
if( $bg_type == 'u_iframe' && $u_video_url != '' ){
	...
	$data_property .= '}';
	echo '<div class="ftc-youtube-video-bg" data-property="'.$data_property.'" data-poster="'.wp_get_attachment_url($video_poster).'"></div>';
}
...
if( $bg_type == 'video' && ($video_url != '' || $video_url_2 != '') ){
	...
	?>
	<div class="ftc-hosted-video-bg" data-poster="<?php echo wp_get_attachment_url($video_poster); ?>">
