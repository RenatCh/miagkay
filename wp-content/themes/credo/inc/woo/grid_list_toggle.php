...
if( !class_exists('Ftc_Grid_List') && ftc_has_woocommerce() ){
	class Ftc_Grid_List{
		function __construct(){
			...
			$this->settings = array(
				array(
					'name' => esc_html__( 'Default catalog view', 'credo' ),
					'type' => 'title',
					'id' => 'ftc_glt_options'
				),
				array(
					'name' 		=> esc_html__( 'Catalog view', 'credo' ),
					'desc_tip' 	=> '',
					'id' 		=> 'ftc_enable_glt',
					'type' 		=> 'checkbox',
					'desc' 		=> esc_html__('Display option to show product in grid or list view', 'credo'),
					'default' 	=> 'yes'
				),
				array(
					'name' 		=> esc_html__( 'Default catalog view', 'credo' ),
					'desc_tip' 	=> esc_html__( 'Display products in grid or list view by default', 'credo' ),
					'id' 		=> 'ftc_glt_default',
					'type' 		=> 'select',
					'options' 	=> array(
						'grid'  => esc_html__('Grid', 'credo'),
						'list' 	=> esc_html__('List', 'credo')
					)
				),
		...
		function gridlist_toggle_button() {
			?>
				<nav class="grid_list_nav">
					<a href="#" id="grid" title="<?php esc_html_e('Grid view', 'credo'); ?>">&#8862; <span><?php esc_html_e('Grid view', 'credo'); ?></span></a><a href="#" id="list" title="<?php esc_html_e('List view', 'credo'); ?>">&#8863; <span><?php esc_html_e('List view', 'credo'); ?></span></a>
				</nav>
			<?php
		}
