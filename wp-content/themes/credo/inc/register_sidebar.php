...
$ftc_default_sidebars = array(
						array(
							'name' => esc_html__( 'Home Sidebar', 'credo' ),
							'id' => 'home-sidebar',
							'description' => '',
						...
						,array(
							'name' => esc_html__( 'Blog Sidebar', 'credo' ),
							'id' => 'blog-sidebar',
							'description' => '',
							'before_widget' => '<section id="%1$s" class="widget-container %2$s">',
							'after_widget' => '</section>',
						...
						,array(
							'name' => esc_html__( 'Blog Detail Sidebar', 'credo' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Sidebar', 'credo' ),
						...
						,array(
							'name' => esc_html__( 'Product Category Top Content', 'credo' ),
						...
						,array(
							'name' => esc_html__( 'Product Detail Sidebar', 'credo' ),
						...
						,array(
							'name'          => __( 'Product Detail Social Icon', 'credo' ),
                                                        'id'            => 'product-detail-social-icon',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => __( 'Add social icon in your product detail page.', 'credo' ),
						)
...
$ftc_default_widgetareas = array(
                                        array(
							'name'          => __( 'Footer Top', 'credo' ),
                                                        'id'            => 'footer-top',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => __( 'Add widgets here to appear in your footer.', 'credo' ),
					)
					,array(
							'name'          => __( 'Footer Middle', 'credo' ),
                                                        'id'            => 'footer-middle',
                                                        'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                        'after_widget' => '</div>',
                                                        'description'   => __( 'Add widgets here to appear in your footer.', 'credo' ),
					...
					,array(
							'name'          => __( 'Footer Bottom', 'credo' ),
                                        ...
                                        ,array(
                                                   'name'          => esc_html__( 'Popup Newletter', 'carna' ),
                                                   'id'            => 'popup-newletter',
                                                   'before_widget' => '<div id="%1$s" class="widget %2$s">',
                                                   'after_widget' => '</div>',
                                                   'description'   => '',
